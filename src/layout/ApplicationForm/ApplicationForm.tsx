...
export const ApplicationForm: FC = () => {
  ...
  const savedIsApplicaionAlreadyAdded = localStorage.getItem("savedIsApplicaionAlreadyAdded")
    ...
    <section className="application" id="application">
      <div className="container">
        ...
        <form ref={formRef} onSubmit={handleSubmitt}>
          ...
          <button type="submit" disabled={buttonIsDisabled} className="submit-btn">
