      ...
      <div className="greeting__inner">
        <div className="greeting__description">
          <animated.h1 style={bigTextProps} className="greeting__text">
            ...
            are here to guide you on your journey. Explore our courses and join
            our vibrant community to speak the language of success. Thank you
            for choosing FaraPrism!
          </animated.h1>
        ...
        <animated.img src={greeetingImage} alt="" style={imageProps} className="greeting__inner-image" />
        {/* <img className="greeting__inner-image" src={greeetingImage} alt="" /> */}
      </div>
    </section>
  );
};
