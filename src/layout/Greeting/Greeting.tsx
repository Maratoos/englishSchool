...
import greetingImage from "../../assets/images/greetingImage.png"
import test from "../../assets/images/test-removebg.png"
import "./greeting.css"
...
export const Greeting: FC = () => {
  ...
  const handleClose = (event?: SyntheticEvent | Event, reason?: string) => {
    ...
    document.cookie = `${encodeURIComponent("isCookieAccepted")}=${encodeURIComponent(
      true,
    )}; path=/; max-age=259200`
    ...
    <>
        ...
        <div className="greeting__inner">
          <div className="greeting__description">
            ...
            <animated.h1 style={bigTextProps} className="greeting__text">
              Я и мои опытные преподаватели научим тебя любить английский язык. Присоединяйся к
              нашему дружному сообществу и достигай успеха в английском.
            </animated.h1>
            <animated.h1 style={bigTextProps} className="greeting__text">
              Ждем тебя на уроке.
            </animated.h1>
          ...
          <animated.div className="greeting__image-holder" style={imageProps}>
            <img className="greeting__image" src={greetingImage} alt="Faruh" />
            <div className="moreShadows" />
          </animated.div>
        </div>
      </section>
      <Modal active={modalActive} setActive={setModalActive}>
        ...
        {!quizActive && !currentLevel && (
          <BeforeQuiz disabled={!documents.length} setQuizActive={setQuizActive} />
        )}
